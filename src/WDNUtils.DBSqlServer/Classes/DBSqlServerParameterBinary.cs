...
{
    /// <summary>
    /// Byte array (BINARY) bind parameter
    /// </summary>
    public sealed class DBSqlServerParameterBinary : DBSqlServerParameter
    {
        /// <summary>
        /// Creates a BINARY bind parameter
        /// </summary>
        ...
        internal DBSqlServerParameterBinary(string name, byte[] value, int? maxSize, ParameterDirection direction)
            : base(parameterName: name, sqlValue: (value is null) ? SqlBinary.Null : new SqlBinary(value), type: SqlDbType.Binary, maxSize: maxSize, direction: direction)
        {
